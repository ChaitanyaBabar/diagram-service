...
import com.tibco.xpd.n2.gat.model.GatBusinessRuleTaskElement;
import com.tibco.xpd.xpdl2.Activity;
import com.tibco.xpd.n2.gat.util.GatModelUtil;

/**
 * Graphical Audit Trail Generator for BusinessRuleTask.
 *
 * @author Sid Allway
 * @since Jan 2026
 */
public class GatBusinessRuleTaskGenerator extends GatActivityGenerator
{
	/**
	 * Constructor
	 *
	 ...
	 * @param xpdlActivity
	 */
	public GatBusinessRuleTaskGenerator(BaseGatGenerator parent, Activity xpdlActivity)
	{
	...
	{
		GatBusinessRuleTaskElement businessRuleTaskElement = new GatBusinessRuleTaskElement(xpdlActivity.getId(),
				xpdlActivity.getName(),
				GatModelUtil.getDisplayNameOrName(xpdlActivity));

		return businessRuleTaskElement;
	}
