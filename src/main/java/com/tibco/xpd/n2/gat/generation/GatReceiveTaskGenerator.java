...
import com.tibco.xpd.n2.gat.model.GatReceiveTaskElement;
import com.tibco.xpd.xpdl2.Activity;
import com.tibco.xpd.n2.gat.util.GatModelUtil;

/**
 * Graphical Audit Trail Generator for ReceiveTask.
 *
 * @author Sid Allway
 * @since Jan 2026
 */
public class GatReceiveTaskGenerator extends GatActivityGenerator
{
	/**
	 * Constructor
	 *
	 ...
	 * @param xpdlActivity
	 */
	public GatReceiveTaskGenerator(BaseGatGenerator parent, Activity xpdlActivity)
	{
	...
	{
		GatReceiveTaskElement receiveTaskElement = new GatReceiveTaskElement(xpdlActivity.getId(),
